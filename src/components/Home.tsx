    ...
    return(
        <div>
            ...
            {(value === 0) ?
                ...
                {(value === 0) ?
                    <CrossCharts data={financiamientos} seccion={'financiamientos'} title={'Financiamientos'}
                    ...
                    <AccionesCharts data={pcu} seccion={'registro'}  title={'Registro de Vivienda'} titleCifras={'viviendas registradas'}
